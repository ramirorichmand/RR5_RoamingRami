...
btn1.addEventListener('click', () => {
    ...
    document.getElementById('dateChange').innerHTML = "June 1, 2023";
})
...
btn2.addEventListener('click', () => {
    ...
    document.getElementById('dateChange').innerHTML = "October 8, 2023";
})
...
btn3.addEventListener('click', () => {
    ...
    document.getElementById('dateChange').innerHTML = "January 20, 2024";
})
